...
CORRELATION_TEMPLATES = [
    {
        ...
        "title_template": "Critical Intelligence: Suspected Underground Nuclear Test involving {entity}",
        "hypothesis_template": "CONCLUSION: Seismic activity near {entity} combined with an active nuclear program and absence of natural tectonic movement suggests possible underground nuclear testing.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "CRIT",
        "trust_bonus": 0.15,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Critical Threat Vector: Coordinated Regime Destabilization Targetting {entity}",
        "hypothesis_template": "CONCLUSION: Withdrawal of economic support to {entity} coinciding with internal unrest and increased foreign military aid suggests coordinated regime destabilization.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "CRIT",
        "trust_bonus": 0.12,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "High Alert: Energy Supply Chain Destabilization impacting {entity}",
        "hypothesis_template": "CONCLUSION: Geopolitical aggression involving {entity} combined with oil market maneuvers suggests a deliberate energy supply chain destabilization strategy.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.10,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Tactical Intelligence: Possible Military Diversion Tactic identified within {entity}",
        "hypothesis_template": "CONCLUSION: Major political scandal coinciding with military escalation suggests possible strategic diversion — military action used to redirect public attention from {entity}-related controversy.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.08,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Strategic Alert: Sustained Economic Coercion Campaign against {entity}",
        "hypothesis_template": "CONCLUSION: Coordinated economic pressure on {entity} alongside diplomatic confrontation indicates a systematic economic coercion campaign.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.08,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "High Alert: Imminent Military Encirclement threatening {entity}",
        "hypothesis_template": "CONCLUSION: Multiple military exercises and arms deals near {entity} combined with new alliance agreements suggest strategic military encirclement.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.10,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Critical Intelligence: Cyber-Kinetic Convergence escalating in {entity}",
        "hypothesis_template": "CONCLUSION: Cyber operations targeting {entity} synchronized with conventional military activity suggests hybrid warfare escalation.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "CRIT",
        "trust_bonus": 0.12,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Tactical Movement: Impending Resource Control Operation identified in {entity}",
        "hypothesis_template": "CONCLUSION: Territorial aggression near {entity} coupled with resource acquisition moves suggests a deliberate resource control strategy.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.10,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "High Risk: Technology Export Chokepoint Weaponization targeting {entity}",
        "hypothesis_template": "CONCLUSION: Technology export restrictions combined with {entity}-related trade actions suggest weaponization of tech supply chain chokepoints.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "HIGH",
        "trust_bonus": 0.08,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Intelligence Brief: Exploitation of Humanitarian Vulnerabilities inside {locations}",
        "hypothesis_template": "CONCLUSION: A natural disaster affecting {entity} has triggered a humanitarian crisis, which is being leveraged as a diplomatic pressure point.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "MED",
        "trust_bonus": 0.06,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Intelligence Brief: Imminent Geopolitical Re-Alignment Fracture indicated concerning {entity}",
        "hypothesis_template": "CONCLUSION: Diplomatic re-alignment of {entity} combined with shifting trade patterns indicates fracturing of existing alliance structures.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "MED",
        "trust_bonus": 0.06,
    },
    {
        ...
        "negative_checks": [],
        "title_template": "Critical Alert: Dangerous Escalation via Proxy Forces linked to {entity}",
        "hypothesis_template": "CONCLUSION: Arms transfers to non-state actors near {entity} combined with civil unrest suggests proxy conflict escalation by external powers.\nACTORS: {actors}\nREGIONS: {locations}",
        "severity": "CRIT",
        "trust_bonus": 0.12,
    },
]
